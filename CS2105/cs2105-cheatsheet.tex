...
\begin{itemize}
    \item New problem: \textbf{Bit error}
    \item Solution:
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item If receive ACK n, check if can shift sliding window
    \end{itemize}
    \item Receiver:
    \begin{itemize}
...
\includegraphics[scale=0.15]{tcp-sequence-and-ack-num}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Start timer, if not running
        \item Timer for \textbf{oldest un-ACKed segment}
    \end{itemize}
    \item If timeout:
    \begin{itemize}
        \item Retransmit segment cuasing timeout (Similar to selective repeat)
        \item Restart timer
    \end{itemize}
...
\includegraphics[scale=0.2]{tcp-fast-retransmit}
