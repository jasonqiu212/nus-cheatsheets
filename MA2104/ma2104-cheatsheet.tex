...
\begin{itemize}
    ...
    \[
        \iint_{R} f(x,y) dA = \iint_{S} f(x(u,v),y(u,v)) |\partialderivative[(x,y)]{(u,v)}| dudv
    \]
    \begin{itemize}
    ...
    \]
    \[
        y(u,v,w),z(u,v,w)) |\partialderivative[(x,y,z)]{(u,v,w)}| dudvdw
    \]
    \item Tips:
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \[
            A = \int_{C} xdy = -\int_{C} ydx = \frac{1}{2}(\int_{C} cdy - ydx)
        \]
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item $\mathbf{n} = \frac{\mathbf{r}_u \times \mathbf{r}_v}{||\mathbf{r}_u \times \mathbf{r}_v||}$ Opposite orientation: $-\mathbf{n}$
    \end{itemize}
