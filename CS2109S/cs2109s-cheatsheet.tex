...
\begin{itemize}
    ...
    \item Idea: Come up with a decision boundary to seperate data points. $h_w (x_1, x_2) = 1$, if $w_0 + w_1 x_1 + w_2 x_2 > 0$, or $0$, otherwise
\end{itemize}
...
\section{09. Support Vector Machine}
...
\begin{itemize}
    ...
    \item Idea: Map features to higher dimensions
    \item Similarity function using gaussian can help construct hypothesis for non-linear
    \item Think of x1, x2, x3 as f1, f2, f3, where fi is some feature mapping
\end{itemize}
