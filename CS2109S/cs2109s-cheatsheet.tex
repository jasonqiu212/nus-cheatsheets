...
\section{04. Introduction to Machine Learning}
...
\includegraphics[scale=0.2]{entropy}
...
\begin{itemize}
    ...
    \item \keyword{Pruning}{Prevent node from being split when split does not split cleanly}
    \begin{itemize}
