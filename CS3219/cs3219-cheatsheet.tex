...
\begin{itemize}
    ...
    \begin{itemize}
        \item \keyword{Event-Driven Communication}{"Something happened"; Async. pattern with real-time data (Published as it is generated) in streams or queues}
        \item \keyword{Request-Response Communication}{"Do this"; Generally sync. which introduces latency and coupling}
    \end{itemize}
